...
![Prefill TTFT: 1.10x slower at 8k context (kleidiai vs generic)](report-20260814-215555-prefill-ttft.png)

### Prefill throughput vs context length (higher is better)
![Prefill throughput vs context length (higher is better)](report-20260814-215555-prefill-throughput.png)

### Which lever mattered
![Which lever mattered](report-20260814-215555-levers.png)

### Prompt cache: 99% of prefill skipped on the warm turn
![Prompt cache: 99% of prefill skipped on the warm turn](report-20260814-215555-prompt-cache.png)

### Throughput vs parallel requests (qwen2.5-0.5b-instruct:q4_0)
![Throughput vs parallel requests (qwen2.5-0.5b-instruct:q4_0)](report-20260814-215555-concurrency.png)
...
<sub>Instance: github-arm-runner (GitHub-hosted Arm runner (ubuntu-24.04-arm)) | CPU: CPU | THP: madvise | firstflight 0.1.0 | generated 2026-08-14 21:55 UTC. Methodology: docs/METHODOLOGY.md</sub>