...
### Prefill TTFT: 1.54x faster at 32k context (kleidiai-q4_0 vs baseline)
![Prefill TTFT: 1.54x faster at 32k context (kleidiai-q4_0 vs baseline)](report-20260809-103114-demo-prefill-ttft.png)

### Prefill throughput vs context length (higher is better)
![Prefill throughput vs context length (higher is better)](report-20260809-103114-demo-prefill-throughput.png)

### Which lever mattered
![Which lever mattered](report-20260809-103114-demo-levers.png)

### Prompt cache: 97% of prefill skipped on the warm turn
![Prompt cache: 97% of prefill skipped on the warm turn](report-20260809-103114-demo-prompt-cache.png)

### Throughput vs parallel requests (qwen2.5-0.5b-instruct [SYNTHETIC]:q4_0)
![Throughput vs parallel requests (qwen2.5-0.5b-instruct [SYNTHETIC]:q4_0)](report-20260809-103114-demo-concurrency.png)

### Cost per million prompt tokens
![Cost per million prompt tokens](report-20260809-103114-demo-cost.png)
...
<sub>Instance: aws-graviton4-c8g-2xlarge (Arm Neoverse-V2 (Graviton4)) | CPU: Arm Neoverse-V2 (Graviton4) [SYNTHETIC] | firstflight 0.1.0 | generated 2026-08-09 10:31 UTC. Methodology: docs/METHODOLOGY.md</sub>