...
## No claimed win: the delta at 8k (1.00x) sits inside the measured 0.3% noise floor

- TTFT 400.74s -> 400.37s at 8,192 tokens (kleidiai vs repack)
- prefill 20 -> 20 tok/s
- generation 36 -> 35 tok/s
- cumulative vs generic: 0.91x at 8k (every rung combined, not kleidiai alone)
- measured noise floor (same build, twice): 0.3% - this delta does NOT clear it - not claimed either way
- measured prompt-cache TTFT: cold 8492ms -> warm 54ms (99% less prefill on the warm turn)

| within noise | 400.37s | 20 | $0.00 |
|---|---|---|---|
| prefill @ 8k vs repack | TTFT @ 8k (kleidiai) | prefill tok/s | $/M prompt tok (free runner) |

### Prefill TTFT: 1.00x faster at 8k context (kleidiai vs repack)
![Prefill TTFT: 1.00x faster at 8k context (kleidiai vs repack)](report-20260814-230410-prefill-ttft.png)

### Prefill throughput vs context length (higher is better)
![Prefill throughput vs context length (higher is better)](report-20260814-230410-prefill-throughput.png)

### Which lever mattered
![Which lever mattered](report-20260814-230410-levers.png)

### Prompt cache: 99% of prefill skipped on the warm turn
![Prompt cache: 99% of prefill skipped on the warm turn](report-20260814-230410-prompt-cache.png)

### Throughput vs parallel requests (qwen2.5-0.5b-instruct:q4_0)
![Throughput vs parallel requests (qwen2.5-0.5b-instruct:q4_0)](report-20260814-230410-concurrency.png)
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| 1,024 | 10.74 | 95 ±0 | 10.77 | 95 ±0 | 38.86 | 26 ±0.00 | 10.81 | 95 ±0.11 | 10.74 | 95 ±0.01 |
| 2,048 | 32.87 | 62 ±0 | 32.84 | 62 ±0 | 79.57 | 26 ±0.00 | 32.94 | 62 ±0.03 | 32.83 | 62 ±0.00 |
| 4,096 | 110.73 | 37 ±0 | 110.74 | 37 ±0 | 166.51 | 25 ±0.00 | 110.83 | 37 ±0.01 | 110.68 | 37 ±0.00 |
| 8,192 | 400.40 | 20 ±0 | 400.67 | 20 ±0 | 362.66 | 23 ±0.01 | 400.74 | 20 ±0.01 | 400.37 | 20 ±0.00 |
...
_Quality = a regression guardrail, not a leaderboard: perplexity per rung, plus a small exact-match probe via llama-completion where it was run. Perplexity spread across rungs: 0.04% (37.4181 to 37.4325) - consistent with the kernels being output-neutral._
