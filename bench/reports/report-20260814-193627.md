...
## 3.62x faster prefill at 1k, inverting to 0.91x at 8k (kleidiai vs generic): the advantage is context-dependent
...
![Prefill TTFT: 1.10x slower at 8k context (kleidiai vs generic)](report-20260814-193627-prefill-ttft.png)

### Prefill throughput vs context length (higher is better)
![Prefill throughput vs context length (higher is better)](report-20260814-193627-prefill-throughput.png)

### Which lever mattered
![Which lever mattered](report-20260814-193627-levers.png)

### Prompt cache: 99% of prefill skipped on the warm turn
![Prompt cache: 99% of prefill skipped on the warm turn](report-20260814-193627-prompt-cache.png)

### Throughput vs parallel requests (qwen2.5-0.5b-instruct:q4_0)
![Throughput vs parallel requests (qwen2.5-0.5b-instruct:q4_0)](report-20260814-193627-concurrency.png)
